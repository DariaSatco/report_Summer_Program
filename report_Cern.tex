...
\section{Conclusions}
Sphalerons explain the $(B+L)$-violation in Standard model and provide a great interest for future collider physics, since they can only be observed in high energy proton-proton collisions. The sphaleron process rate is absolutely unknown, but it is still possible to mark out such properties of these process as the huge number of produced W-bosons and leptons. We used HERBVI for the sphaleron simulation, studied the influence of parton and boson distributions on the sphaleron decay products. The output was modified to the format common for collider physics (HepMC), hence it is easy to continue detector simulation and further statistical analysis of the HERBVI results. The background simulation was performed and it was shown that one can confidently consider zero background for the region where the produced lepton number is higher than 6 for 14 TeV, 10 - for 33-40 TeV and 12 for 100 TeV. The qualitative analysis of sphaleron process was carried out, the upper limit for the cross section were set, however, its magnitude remains undefined.
